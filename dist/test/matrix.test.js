...
test('Check matrix dimensions', () => {
    let m = new index_1.Matrix([[1, -3, 2], [1, 2, 7]]); // m = 2, n = 3
    expect(m.dim()).toEqual([2, 3]);
});
test('Check matrix properties', () => {
    let m = new index_1.Matrix([[1, -3, 2], [1, 2, 7]]); // m = 2, n = 3
    expect(m.isSquare()).toBe(false);
    m = new index_1.Matrix([[1, -2], [1, 2]]); // m = 2, n = 2
...
test('Matrix mirroring', () => {
    let a = new index_1.Matrix([[1, -3, 2], [1, 2, 7]]); // m = 2, n = 3
    expect(a.mirrorColumns().toArr()).toEqual([[2, -3, 1], [7, 2, 1]]);
    let b = new index_1.Matrix([[1, -3, 2, 6], [1, 2, 7, -3]]);
    expect(b.mirrorColumns().toArr()).toEqual([[6, 2, -3, 1], [-3, 7, 2, 1]]);
    let c = new index_1.Matrix([[1, -3, 2], [1, 2, 7]]);
    expect(c.mirrorRows().toArr()).toEqual([[1, 2, 7], [1, -3, 2]]);
    let d = new index_1.Matrix([[1, -3, 2, 6], [1, 2, 7, -3]]);
    expect(d.mirrorRows().toArr()).toEqual([[1, 2, 7, -3], [1, -3, 2, 6]]);
});
test('Matrix multiplication', () => {
    let a = new index_1.Matrix([[3, 2, 1], [1, 0, 2]]);
    let b = new index_1.Matrix([[1, 2], [0, 1], [4, 0]]);
    expect(a.multiply(b).toArr()).toEqual([[7, 8], [9, 2]]);
});
test('Matrix Hadamard product (element wise)', () => {
    let a = new index_1.Matrix([[3, 2], [0, 1]]);
    let b = new index_1.Matrix([[1, 2], [3, 1]]);
...
test('Matrix addition', () => {
    let a = new index_1.Matrix([[1, -3, 2], [1, 2, 7]]); // m = 2, n = 3
    let b = new index_1.Matrix([[0, 3, 5], [2, 1, -1]]); // m = 2, n = 3
...
test('Vector creation', () => {
    let v = new index_1.Vector([1, -3, 2]);
    expect(v.dim()).toEqual(3);
    let w = new index_1.Vector(3);
    expect(w.dim()).toEqual(3);
});
test('Vector addition', () => {
    let u = new index_1.Vector([1, -3, 2]);
    let v = new index_1.Vector([4, -5, 6]);
...
test('Chaining', () => {
    let v = new index_1.Vector([2, 5, 7]);
    let w = new index_1.Vector([1, -3, -2]);
